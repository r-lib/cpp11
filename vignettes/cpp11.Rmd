...
Before building the package, you'll need to run `cpp11::cpp_generate_bindings()`.
This function scans the C++ files for `[[cpp11::export]]` attributes and generates the binding code required to make the functions available in R.
Re-run `cpp11::cpp_generate_bindings()` whenever functions are added, removed, or have their signatures changed.
If you are using `devtools` to develop your package this is done automatically by the pkgbuild package.
