...
* Section [source_cpp](#source-cpp) shows you how to use `cpp11::source_cpp()` to load a C++ file from disk in the same way you use `source()` to load a file of R code.
...
[[cpp11::export]] cpp11::doubles_matrix gibbs_cpp(int N, int thin) {
