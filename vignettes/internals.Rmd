...
You may need to unlink your previous version of `clang-format` and link the newly installed version 10. To do so, run `brew unlink clang-format` followed by `brew link clang-format@10`.
