...
In order to calculate code coverage you need to call `cpp11_coverage()`, e.g. to generate a local coverage report you could use the following.
...
All of the basic r_vector classes are class templates, the base template is defined in [cpp11/vector.hpp](https://github.com/r-lib/cpp11/blob/master/inst/include/cpp11/vector.hpp)
...
4. Have `cpp11::unwind_protect()` be a no-op, this would mean any resources held by C++ objects would leak, including cpp11::r_vector / cpp11::sexp objects.
