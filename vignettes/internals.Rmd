...
You can run `make format` to re-format all code in the project. If your system does not have `clang-format` version 10, this can be installed using a homebrew tap available at [r-lib/homebrew-taps](https://github.com/r-lib/homebrew-taps).
