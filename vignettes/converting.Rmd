...
| ---                     | ---                   | ---                         | ---                            |
| NumericVector           | doubles               | writable::doubles           | <headers/doubles.hpp>          |
| NumericMatrix           | doubles_matrix<>      | writable::doubles_matrix<>  | <headers/doubles.hpp>          |
| IntegerVector           | integers              | writable::integers          | <headers/integers.hpp>         |
| IntegerMatrix           | integers_matrix<>     | writable::integers_matrix<> | <headers/integers.hpp>         |
| CharacterVector         | strings               | writable::strings           | <headers/strings.hpp>          |
| RawVector               | raws                  | writable::raws              | <headers/raws.hpp>             |
| List                    | list                  | writable::list              | <headers/list.hpp>             |
| RObject                 | sexp                  |                             | <headers/sexp.hpp>             |
| XPtr                    |                       | external_pointer            | <headers/external_pointer.hpp> |
| Environment             |                       | environment                 | <headers/environment.hpp>      |
| Function                |                       | function                    | <headers/function.hpp>         |
| Environment (namespace) |                       | package                     | <headers/function.hpp>         |
| wrap                    |                       | as_sexp                     | <headers/as.hpp>               |
| as                      |                       | as_cpp                      | <headers/as.hpp>               |
| stop                    | stop                  |                             | <headers/protect.hpp>          |
| checkUserInterrupt      | check_user_interrupt  |                             | <headers/protect.hpp>          |
...
If you include `headers/R.hpp` before any R headers these macros will be defined appropriately, otherwise you may see errors like
