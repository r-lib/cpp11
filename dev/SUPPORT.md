...
Thanks for using cpp11! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/r-lib/cpp11/issues/new).
...
requests](https://github.com/r-lib/cpp11/issues) to make sure the bug
